...
public class reporteHabitantesVivienda extends javax.swing.JFrame {
    ...
    private void cargarMunicipios() {
        ...
        // TEMPORAL:
        cboFiltro.addItem("Monclova");
        cboFiltro.addItem("Parras");
        cboFiltro.addItem("Sacramento");
    }
    ...
    public void cargarDatosTabla(String municipioSeleccionado) {
        ...
        try {
            ...
            for (Map<String, Object> fila : listaReporte) {
                ...
                // Asignar los valores del Map a las columnas de la tabla en el orden correcto
    ...
    private void initComponents() {
        ...
        panelFiltrosLayout.setHorizontalGroup(
            ...
            .addGroup(panelFiltrosLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 542, Short.MAX_VALUE)
